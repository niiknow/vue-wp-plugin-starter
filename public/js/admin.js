...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  return (0, _vue.openBlock)(), (0, _vue.createElementBlock)("div", _hoisted_1, [(0, _vue.createElementVNode)("section", _hoisted_2, (0, _vue.toDisplayString)(_ctx.msg), 1 /* TEXT */)]);
}
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return _ctx.hasLoaded ? ((0, _vue.openBlock)(), (0, _vue.createElementBlock)("div", _hoisted_1, [(0, _vue.createElementVNode)("aside", _hoisted_2, [(0, _vue.createElementVNode)("div", _hoisted_3, [(0, _vue.createElementVNode)("div", _hoisted_4, [(0, _vue.createVNode)(_component_t_button, {
    ...
    _: 1 /* STABLE */
  }, 8 /* PROPS */, ["disabled", "data-rerendered"]), (0, _vue.createVNode)(_component_t_button, {
    ...
    _: 1 /* STABLE */
  }, 8 /* PROPS */, ["disabled", "data-rerendered"])]), (0, _vue.withDirectives)(((0, _vue.openBlock)(), (0, _vue.createElementBlock)("ul", _hoisted_5, [((0, _vue.openBlock)(true), (0, _vue.createElementBlock)(_vue.Fragment, null, (0, _vue.renderList)(_ctx.structure.sections, function (value, name) {
    return (0, _vue.openBlock)(), (0, _vue.createElementBlock)("li", _hoisted_6, [(0, _vue.createElementVNode)("a", _hoisted_7, [(0, _vue.createElementVNode)("span", _hoisted_8, (0, _vue.toDisplayString)(value), 1 /* TEXT */)])]);
  }), 256 /* UNKEYED_FRAGMENT */))])), [[_directive_scroll_spy_active, {
    selector: 'li',
    class: 'active'
  }], [_directive_scroll_spy_link]])])]), (0, _vue.createCommentVNode)("Section container"), (0, _vue.createElementVNode)("section", _hoisted_9, [(0, _vue.withDirectives)(((0, _vue.openBlock)(), (0, _vue.createElementBlock)("div", _hoisted_10, [((0, _vue.openBlock)(true), (0, _vue.createElementBlock)(_vue.Fragment, null, (0, _vue.renderList)(_ctx.structure.sections, function (value, name) {
    return (0, _vue.openBlock)(), (0, _vue.createElementBlock)("div", _hoisted_11, [(0, _vue.createCommentVNode)("Title"), (0, _vue.createElementVNode)("h2", _hoisted_12, (0, _vue.toDisplayString)(value), 1 /* TEXT */), (0, _vue.createCommentVNode)("Card"), (0, _vue.createElementVNode)("div", _hoisted_13, [((0, _vue.openBlock)(true), (0, _vue.createElementBlock)(_vue.Fragment, null, (0, _vue.renderList)(_ctx.getOptions(name), function (item) {
      return (0, _vue.openBlock)(), (0, _vue.createElementBlock)("div", _hoisted_14, [(0, _vue.createElementVNode)("div", _hoisted_15, [(0, _vue.createElementVNode)("label", _hoisted_16, (0, _vue.toDisplayString)(item.name), 1 /* TEXT */), (0, _vue.createElementVNode)("p", _hoisted_17, (0, _vue.toDisplayString)(item.description), 1 /* TEXT */)]), (0, _vue.createElementVNode)("div", _hoisted_18, [item.type === 'toggle' ? ((0, _vue.openBlock)(), (0, _vue.createElementBlock)("div", _hoisted_19, [(0, _vue.createVNode)(_component_t_toggle, {
        modelValue: _ctx.settings[item.id],
        "onUpdate:modelValue": function onUpdateModelValue($event) {
          return _ctx.settings[item.id] = $event;
        }
      }, null, 8 /* PROPS */, ["modelValue", "onUpdate:modelValue"])])) : item.type === 'dropdownMultiselect' ? ((0, _vue.openBlock)(), (0, _vue.createElementBlock)("div", _hoisted_20, [(0, _vue.createVNode)(_component_t_rich_select, {
        modelValue: _ctx.settings[item.id],
        "onUpdate:modelValue": function onUpdateModelValue($event) {
          return _ctx.settings[item.id] = $event;
        },
        ...
        multiple: "",
        tags: ""
      }, null, 8 /* PROPS */, ["modelValue", "onUpdate:modelValue", "options"])])) : item.type === 'dropdown' ? ((0, _vue.openBlock)(), (0, _vue.createElementBlock)("div", _hoisted_21, [(0, _vue.createVNode)(_component_t_select, {
        modelValue: _ctx.settings[item.id],
        "onUpdate:modelValue": function onUpdateModelValue($event) {
          return _ctx.settings[item.id] = $event;
        },
        options: item.options
      }, null, 8 /* PROPS */, ["modelValue", "onUpdate:modelValue", "options"])])) : ['textarea'].indexOf(item.type) > -1 ? ((0, _vue.openBlock)(), (0, _vue.createElementBlock)("div", _hoisted_22, [(0, _vue.createVNode)(_component_t_textarea, {
        modelValue: _ctx.settings[item.id],
        "onUpdate:modelValue": function onUpdateModelValue($event) {
          return _ctx.settings[item.id] = $event;
        }
      }, null, 8 /* PROPS */, ["modelValue", "onUpdate:modelValue"])])) : item.type === 'code' ? ((0, _vue.openBlock)(), (0, _vue.createElementBlock)("div", _hoisted_23, [(0, _vue.createVNode)(_component_v_ace_editor, {
        modelValue: _ctx.settings[item.id],
        "onUpdate:modelValue": function onUpdateModelValue($event) {
          return _ctx.settings[item.id] = $event;
        },
      ...
      }, null, 8 /* PROPS */, ["modelValue", "onUpdate:modelValue"])])) : item.type === 'color' ? ((0, _vue.openBlock)(), (0, _vue.createElementBlock)("div", _hoisted_24, [(0, _vue.createVNode)(_component_color_input, {
        modelValue: _ctx.settings[item.id],
        "onUpdate:modelValue": function onUpdateModelValue($event) {
          return _ctx.settings[item.id] = $event;
        },
        format: "hex"
      }, null, 8 /* PROPS */, ["modelValue", "onUpdate:modelValue"])])) : ((0, _vue.openBlock)(), (0, _vue.createElementBlock)("div", _hoisted_25, [(0, _vue.createVNode)(_component_t_input, {
        modelValue: _ctx.settings[item.id],
        "onUpdate:modelValue": function onUpdateModelValue($event) {
          return _ctx.settings[item.id] = $event;
        },
    ...
    }), 256 /* UNKEYED_FRAGMENT */))]), (0, _vue.createCommentVNode)("/Card")]);
  }), 256 /* UNKEYED_FRAGMENT */))])), [[_directive_scroll_spy]])])])) : (0, _vue.createCommentVNode)("v-if", true);
}
...
;
const __exports__ = /*#__PURE__*/(0,_node_modules_vue_loader_dist_exportHelper_js__WEBPACK_IMPORTED_MODULE_2__["default"])(_App_vue_vue_type_script_lang_ts__WEBPACK_IMPORTED_MODULE_1__["default"], [['render',_App_vue_vue_type_template_id_3a030f38_ts_true__WEBPACK_IMPORTED_MODULE_0__.render],['__file',"src/admin/App.vue"]])
/* hot reload */
if (false) {}
