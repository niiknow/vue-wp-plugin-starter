<template>
  <div class="app-settings bg-gray-100 text-gray-900 tracking-wider leading-normal">
    ...
    <nav id="header" class="bg-white fixed w-full z-10 top-0 shadow">
        ...
        <div class="w-full container mx-auto flex flex-wrap items-center justify-between my-4">
            ...
            <div class="pl-4 md:pl-0">
                <a class="flex items-center text-yellow-600 text-base xl:text-xl no-underline hover:no-underline font-extrabold font-sans" href="javascript:void(0)">
                ...
                <div class="flex relative inline-block float-right">
                    ...
                    <div class="relative text-sm">
                        ...
                        <div id="userMenu" class="bg-white rounded shadow-md mt-2 mr-2 absolute mt-12 top-0 right-0 min-w-full overflow-auto z-30 invisible">
                            <ul class="list-reset">
                                <li><a href="javascript:void(0)" class="px-4 py-2 block hover:bg-gray-400 no-underline hover:no-underline">My account</a></li>
                                <li><a href="javascript:void(0)" class="px-4 py-2 block hover:bg-gray-400 no-underline hover:no-underline">Notifications</a></li>
                                <li>
                                    <hr class="border-t mx-2 border-gray-400">
                                </li>
                                <li><a href="javascript:void(0)" class="px-4 py-2 block text-yellow-600 font-bold hover:bg-yellow-600 hover:text-white no-underline hover:no-underline">Logout</a></li>
                            </ul>
                        </div>
                    </div>
...
<div v-scroll-spy>
  <div>
            ...
            <div class="p-8 mt-6 lg:mt-0 leading-normal rounded shadow bg-white">
                <li>Using assets build of admin.css</li>
                <li>This template uses vue3-scroll-spy</li>
            </div>
            <!--/Card-->
  </div>
  <div>
  ...
  <div>
        ...
        <div class="w-full lg:w-4/5 lg:ml-auto text-base md:text-sm text-gray-600 px-4 py-24 mb-12">
          <span class="text-base text-yellow-600 font-bold">&lt;</span> <a href="javascript:void(0)" class="text-base md:text-sm text-yellow-600 font-bold no-underline hover:underline">Back link</a>
         </div>
