...
final class Base_Plugin {
    ...
    public function define_constants() {
        define( 'BASEPLUGINCONST_VERSION', $this->version );
        define( 'BASEPLUGINCONST_FILE', __FILE__ );
        define( 'BASEPLUGINCONST_PATH', dirname( BASEPLUGINCONST_FILE ) );
        define( 'BASEPLUGINCONST_INCLUDES', BASEPLUGINCONST_PATH . '/includes' );
        define( 'BASEPLUGINCONST_URL', plugins_url( '', BASEPLUGINCONST_FILE ) );
        define( 'BASEPLUGINCONST_ASSETS', BASEPLUGINCONST_URL . '/public' );
    }
    ...
    public function activate() {
        ...
        update_option( 'pluginprefix_version', BASEPLUGINCONST_VERSION );
    }
    ...
    public function includes() {
        ...
        require_once BASEPLUGINCONST_INCLUDES . '/Api.php';
    }
    ...
    public function localization_setup() {
        load_plugin_textdomain( 'Base_Plugin', false, dirname( plugin_basename( __FILE__ ) ) . '/languages/' );
    }
